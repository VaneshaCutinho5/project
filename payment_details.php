	...
	<body>
		...
		<form action="payment_details_form_handler.php" method="post">
			...
			<?php
				...
				$total_insurance_fee=$_SESSION['total_insurance_fee'];
				$total_ticket_price=$_SESSION['total_ticket_price'];
				$total_meal_price=$_SESSION['total_meal_price'];
				$total_discount=$_SESSION['total_discount'];
				$total_lounge_access_fee=$_SESSION['total_lounge_access_fee'];
				$total_priority_checkin_fee=$_SESSION['total_priority_checkin_fee'];
				$payment_id=rand(100000000,999999999);
				$pnr=$_SESSION['pnr'];
				$_SESSION['payment_id']=$payment_id;
				$_SESSION['no_of_pass']=$no_of_pass;
				$_SESSION['total_insurance_fee']=$total_insurance_fee;
				$_SESSION['total_ticket_price']=$total_ticket_price;
				$_SESSION['total_meal_price']=$total_meal_price;
				$_SESSION['total_discount']=$total_discount;
				$_SESSION['total_lounge_access_fee']=$total_lounge_access_fee;
				$_SESSION['total_priority_checkin_fee']=$total_priority_checkin_fee;
				...
				$total_ticket_price=1000;
				$total_meal_price=250;
				$total_insurance_fee=100;
				$total_priority_checkin_fee=200;
				$total_lounge_access_fee=300;
				$total_discount=10;
